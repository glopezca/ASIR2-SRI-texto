...
> 🧭 **ANTES DE UTILIZAR DOCKER**
>
> Una **imagen** es la plantilla a partir de la que se crea un contenedor; un **contenedor** es una instancia en ejecución de esa imagen. Una **red Docker** permite comunicar contenedores y un **volumen** conserva datos fuera del ciclo de vida del contenedor. **Docker Compose** permite describir varios servicios en un archivo declarativo.
