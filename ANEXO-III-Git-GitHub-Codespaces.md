...
> 🧭 **ANTES DE UTILIZAR GIT Y GITHUB**
>
> **Git** es un sistema distribuido de control de versiones. Un **repositorio** contiene el historial y los archivos del proyecto; un **commit** registra una instantánea de cambios; una **rama** permite trabajar en una línea de desarrollo independiente; **GitHub** aloja repositorios y añade colaboración; un **Codespace** es un entorno de desarrollo remoto asociado a un repositorio.
