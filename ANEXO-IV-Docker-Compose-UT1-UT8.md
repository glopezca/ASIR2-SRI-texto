# 🧱 ANEXO IV · Infraestructura de las UT1–UT8 con Docker Compose
...
En el entorno de generación de esta v4 no existe Docker Engine ni un Codespace ejecutable. Por tanto, esta guía **no afirma haber ejecutado extremo a extremo** los ocho Compose. Antes de usar estos despliegues como evaluación práctica deben probarse en:
