...
> 🧭 **ANTES DE HABLAR DE OBSERVABILIDAD**
>
> **Observabilidad** es la capacidad de comprender el estado interno de un sistema a partir de señales observables como logs, métricas y trazas. **Troubleshooting** es el proceso sistemático de localizar y corregir una incidencia. Una **prueba** debe tener una condición, una acción y un resultado esperado que pueda verificarse.
