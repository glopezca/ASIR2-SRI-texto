...
> 🧭 **ANTES DE UTILIZAR ESTE ENTORNO**
>
> **Docker Compose** permite definir varios servicios relacionados en un archivo declarativo. Un **servicio** representa una parte de la aplicación que Compose ejecuta a partir de una imagen o una construcción local. Las **redes** conectan los servicios, los **puertos publicados** permiten acceso desde fuera de la red de contenedores y los **volúmenes** conservan datos.
...
> ☸️ **Continuación natural:** una vez comprendida y probada la infraestructura Compose, el **[Anexo VII · Migración guiada de Docker Compose a Kubernetes](ANEXO-VII-Compose-a-Kubernetes.md)** muestra cómo trasladar progresivamente sus componentes al modelo de Kubernetes.
